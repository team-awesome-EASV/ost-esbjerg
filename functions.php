...
acf_add_local_field_group(array(
	...
	'fields' => array(
		...
		array(
			...
			'placeholder' => 'enter a small description for the product',
			'prepend' => '',
			'append' => '',
			'maxlength' => 250,
		),
		...
		array(
			...
			'placeholder' => 'enter a small description for the pizza product',
			'prepend' => '',
			'append' => '',
			'maxlength' => 250,
		),
		array(
			...
			'name' => 'cheese_title',
			'type' => 'text',
			'instructions' => 'title for the cheese intro text',
			'required' => 1,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			...
			'type' => 'text',
			'instructions' => 'cheese intro text',
			'required' => 1,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			...
			'default_value' => 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit veniam voluptatem illum eveniet pariatur dolore, consectetur delectus illo ut. Quidem corporis explicabo officia possimus quae iure debitis voluptatem commodi eius!',
			'placeholder' => 'input text for the first about cheese paragraph',
			'prepend' => '',
			'append' => '',
			'maxlength' => 250,
		),
		...
		array(
			...
			'default_value' => 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit veniam voluptatem illum eveniet pariatur dolore, consectetur delectus illo ut. Quidem corporis explicabo officia possimus quae iure debitis voluptatem commodi eius!',
			'placeholder' => 'input text for the second about cheese paragraph',
			'prepend' => '',
			'append' => '',
			'maxlength' => 250,
		),
...
acf_add_local_field_group(array(
	...
	'fields' => array(
		...
		array(
			...
			'placeholder' => 'enter content for paragraph one',
			'prepend' => '',
			'append' => '',
			'maxlength' => '',
		),
		...
		array(
			...
			'default_value' => 'Man kan fremad se, at de har været udset til at læse, at der skal dannes par af ligheder. Dermed kan der afsluttes uden løse ender, og de kan optimeres fra oven af at formidles stort uden brug fra presse. I en kant af landet går der blandt om, at de vil sætte den over forbehold for tiden.',
			'placeholder' => 'enter content for paragraph two',
			'prepend' => '',
			'append' => '',
			'maxlength' => '',
		),
		...
		array(
			...
			'default_value' => 'Man kan fremad se, at de har været udset til at læse, at der skal dannes par af ligheder. Dermed kan der afsluttes uden løse ender, og de kan optimeres fra oven af at formidles stort uden brug fra presse. I en kant af landet går der blandt om, at de vil sætte den over forbehold for tiden.',
			'placeholder' => 'enter content for the paragraph about Katherine',
			'prepend' => '',
			'append' => '',
			'maxlength' => '',
		),
